...
let ReviewsController = class ReviewsController {
    ...
    async findByEstablishment(id, page, limit) {
        return this.reviewsService.findByEntity('establishment', id, { page, limit });
    }
    async findByPosSystem(id, page, limit) {
...
__decorate([
    (0, common_1.Get)('establishment/:id'),
    (0, public_decorator_1.Public)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get reviews for an establishment' }),
...
], ReviewsController.prototype, "findByEstablishment", null);
__decorate([
    (0, common_1.Get)('pos-system/:id'),
    (0, public_decorator_1.Public)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get reviews for a POS system' }),
    (0, swagger_1.ApiQuery)({ name: 'page', required: false, type: Number }),
    (0, swagger_1.ApiQuery)({ name: 'limit', required: false, type: Number }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Query)('page')),
    ...
    __metadata("design:paramtypes", [String, Number, Number]),
    __metadata("design:returntype", Promise)
], ReviewsController.prototype, "findByPosSystem", null);
__decorate([
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Review created and pending moderation' }),
...
__decorate([
    ...
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Respond to a review (Business owner or Admin)' }),
    __param(0, (0, common_1.Param)('id')),
